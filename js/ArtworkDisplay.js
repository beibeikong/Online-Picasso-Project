...
function refreshAll(href)
{
        var param ='painting_collage_photograph_sculpture_ceramic_drawing_watercolor_gouache_pastel_engraving_lithograph_other';
        href = href.replace(/&page=\d\d/, '');
	href = href.replace(/&page=\d/, '');
	if(href.indexOf('category')==-1) // include the category this time
	{
	    href = href + '&category=' + param;
	}
	else
	{
            href = href.substring(0,href.indexOf('&category'));
	}
