...
<title>Artwork Exhibited - <?=PROJECTNAME?></title>
  ...
  <tr>
   ...
   <br/><small><font color="#808080">Copyright © Estate of Pablo Picasso/<br/>Artists Rights Society (ARS), New York</font></small>
      ...
      <?php  }?>
       ...
       <?php 
           if(($row['bookCatalog']!='')&& (strpos($row['bookCatalog'],'*') !== false)) { ?>
        <td  align="left" valign="top"> <iframe id="noteiframe" class="iframeNote" src ="index.php?view=exhibitedPrint&OPPID=<?=$_GET['OPPID']?><?php if(isset($_GET['highlight'])) echo("&highlight=$_GET[highlight]");?>" align="left" width="97%" height="450px"  scrolling="auto" frameborder="0">
        </iframe></td>  
       <?php } ?>     
</tr>
   </table>
