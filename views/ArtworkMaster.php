...
<table class="HeaderBar" cellspacing="0">
  <tr>
    ...
    <td class="Title">Artist Comparison</td>
    <td class="Toolbar">
...
<table id="ArtworkCompare" cellspacing="0" align="center">
 <tr>
    ...
    <td id="ImgHolder"><a href="index.php?view=MasterArtworkInfoNew&MasterID=<?=$right_row['masteropp']?>" target="_blank" onclick="OpenWin(this.href, 'MasterArtworkInfoNew', 740, 550); return false;">
	<?php if ($_SESSION['UserType'] == 'admin' || $right_row['notVerified'] == 0){?>
	<img src="../mastergraphics/<?=substr($right_row['masteropp'],0,7)?>/ythumbs/y<?=$obj->imgName($right_row['masteropp'])?>.jpg" class="imageStyle" title="<?=$right_row['title']?>"/>
	<?php }
	else {?>
	<img src="https://picasso.shsu.edu/images/yopp-emblem-innershadow.jpg"/>
	<?php }?>
