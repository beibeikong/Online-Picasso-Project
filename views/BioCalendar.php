...
<title>Biography Calendar of <?=$_GET['year']?> - On-line Picasso Project</title>
...
<?php
require_once(MODULES_PATH.'BioCalendar.php');
		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
	            <td class="Active"><img src="./images/magnify-art.png"/>Biography Calendar</td>
...
<table border="0" align="center">
  <tr>
    <td class="seasonHeader"><?=$cal->getSeason(0)?></td>
	<td>&nbsp;&nbsp;</td>
