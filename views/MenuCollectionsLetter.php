...
<title>Collections Search - <?=PROJECTNAME?></title>
<link rel="stylesheet" href="./css/menu.css"/>
<script type="text/javascript" src="./js/menu.js"></script>
</head>

<body onload="Initialize('Collections Search'); AutoSizePopup();">
...
<table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
  <tr class="Tabs">
  	<td class="Active"><img src="./images/magnify-art.png"/>Current</td>
	<td class="Inactive"><a href="index.php?view=MenuFormerCollections"><img src="./images/magnify-text.png"/>Former</a></td>
...
<form method="get" action="index.php" target="OPPMain" name="CollectionSearchForm" id="CollectionSearchForm">
	<input type="text" name="view" id="view" size="1" value="CollectSearch" style=" display:none"/>
