...
<table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
  <tr class="Tabs">
  	<td class="Inactive"><a href="index.php?view=MenuBiographyYear"><img src="./images/magnify-art.png"/>Year Index</a></td>
	...
	<input type="text" name="page" id="page" size="1" value="1" style=" display:none"/>
	  <table class="SearchForm" id="BioSearch" cellspacing="0" align="center">
		...
		<tr>
			...
			<td class="fieldCtrls"><input type="text" name="Commentary" id="Commentary" size="33"/><input type="checkbox" name="Commentaryres" id="Commentaryres" value="yes"  onclick="disableCommentary(this.form)" /> any</td>		
		</tr>
