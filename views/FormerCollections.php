...
<?php
require_once(MODULES_PATH.'FormerCollections.php');
$obj = new FormerCollections($_GET['letter']);
$result = $obj->getData();
$totalNum = $obj->getTotalNum();
$middle = ceil($totalNum/2);
$para='&Location=&Date=&Amount=&CategorySearchIn1=painting&CategorySearchIn6=drawing&CategorySearchIn8=gouache&CategorySearchIn9=pastel&CategorySearchIn7=watercolor&CategorySearchIn4=sculpture&CategorySearchIn2=collage&CategorySearchIn3=photograph&CategorySearchIn10=engraving&CategorySearchIn11=lithograph&CategorySearchIn5=ceramic&CategorySearchIn12=other&SearchStyle=Continuous&SearchBy=monthday&StartMonth=1&StartDay=1&StartYear=1881&EndMonth=12&EndDay=31&EndYear=1973';
?>
<center>
    ...
    <td width="50%" valign="top">
	  <table width="98%" class="EntriesList" align="center" cellpadding="1"  cellspacing="0">
	    ...
	    <tr <?=($i%2!=0)? "class=\"Even\"" : ""?>>
    	  ...
    	  <td class="authors" align="left" valign="top" ><b><a href="index.php?view=FormerCollecArtworkSearchP&page=1&Keyword=<?=urlencode($row['collector']).$para?>" class="collection"><?=$row['collector']?></a></b></td>
