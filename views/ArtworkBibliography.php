...
<title>Artwork Bibliography - <?=PROJECTNAME?></title>
...
<iframe id="noteiframe" class="iframeNote" src ="index.php?view=bibliography&OPPID=<?=$_GET['OPPID']?><?php if(isset($_GET['highlight'])) echo("&highlight=$_GET[highlight]");?>" align="left" width="97%" height="450px"  scrolling="auto" frameborder="0">
</iframe></td>
</tr>
   </table>
