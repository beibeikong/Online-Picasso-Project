...
require_once(MODULES_PATH.'ArtworkConcordance.php');
		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
  	            <td class="Inactive"><a href="index.php?view=BioIndex&year=<?=$_GET['year']?>"><img src="./images/magnify-text.png"/>Biography</a></td>
	            <?php
				                        $href = "index.php?".$_SERVER['QUERY_STRING'];
				                        $href = str_replace("ArtworkConcordance", "ArtworkDisplay", $href);
                ?>
	            <td class="Inactive"><a href="<?=$href?>"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
                    <?php
                        $href = "index.php?".$_SERVER['QUERY_STRING'];
                        $href = str_replace("ArtworkConcordance", "ArtworkSummary", $href);
                    ?>
  ...
  <tr>
	...
	<td width="150px" align="right" >        
            <table cellspacing="0" style="clear:none; float:right">
                ...
                <td><a class="PageButton" href="javascript:;" target="_self" onclick="SubmitWorksAll('ArtworkList','ArtworkConcordanceAll');" return false;" title="Show entire Artwork concordance."><img src="./images/icon-addtobasket.gif" width="16" height="16" border="0" alt=""/><br/>All</a></td> 
                </tr>
            </table>
       </td>
  </tr>
...
<table width="auto" align="center" cellpadding="0" cellspacing="0" style="border-width:1px 1px 0px 1px; border-color: #eeeeee; border-style: solid;">
  ...
  <tr class="<?php if($i%2==0) { echo("Even"); } else { echo("Odd");} ?>">
      <td class="ckbox"><input name="check_list" type="checkbox" class="smallcheck" value="<?=$row[key($crntCatalog)]?>" /></td>
