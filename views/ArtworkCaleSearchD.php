...
<title>Artwork Search Display - On-line Picasso Project</title>
...
require_once(MODULES_PATH.'ArtworkCaleSearchD.php');
$obj = new ArtworkCaleSearchD($_GET);
$result = $obj->getData();
...
$hrefForSmall = str_replace("ArtworkCaleSearchD", "ArtworkCaleSearchPrintS", $href_temp);
$hrefForLarge = str_replace("ArtworkCaleSearchD", "ArtworkCaleSearchPrintL", $href_temp);
?>
<center>
		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCaleSearchD","BioCalendarSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Biography</a></td>
				<td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCaleSearchD","ArtworkCaleSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>
  ...
  <tr>
	...
	<td width="150px" align="right" >
	  ...
	  <table cellspacing="0" style="clear:none; float:right">
	    <tr>
          <td>
	        <a class="PageButton" href="<?=$hrefForSmall?>" target="_blank" onclick="if(!PrintWarning()) return false;" title="Print small thumbnails and details."><img src="./images/icon-print.gif" width="16" height="16" border="0"/><br/>Small</a>
		  </td>
          <td>
            <a class="PageButton" href="<?=$hrefForLarge?>" target="_blank" onclick="if(!PrintWarning()) return false;" title="Print large thumbnails and details."><img src="./images/icon-print.gif" width="16" height="16" border="0"/><br/>Large</a>
		  </td>
		</tr>
      </table>
	  <?php } ?>
...
<tr>
  <td width="20%">
    <table class="ThumbGallery">
	  ...
	  ?>
	  <img src="../graphics/<?= $row['StartYear']?>/xthumbs/x<?=$obj->imgName($row['opp'])?>.jpg" class="imageStyle" title="<?=$row['title']?>"/>
	  <?php
	  }
	  else{
	  	?>
      ...
      <tr><td align="center" valign="middle"><input type="checkbox" value="<?=$row['opp']?>" />
