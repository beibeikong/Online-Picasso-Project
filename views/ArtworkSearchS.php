		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchS","ArtworkSearchD",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
		     <td class="Active"><img src="./images/magnify-text.png"/>Artwork Summary</td>
                     <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchS","ArtworkCommSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Commentary</a></td>
                <?php
				$commentaryExist = ture; $AuctionExist = false;
                                if (isset($_GET['NoteAll'])||$_GET['ArtworkKeywords']!="") $AuctionExist = true; 
				if(($_GET['Commentaryres']="")||$_GET['Commentary']=""){  $commentaryExist = false; ?> 
                                echo ("<td class=\"InactiveEmpty\">&nbsp;</td>");     
  	            
				<?php }
				if(($_GET['AuctionKeyword1']!="" || $_GET['AuctionKeyword2']!="" || $_GET['AuctionKeyword3']!="" || $_GET['AuctionKeyword4']!="" || $_GET['AuctionKeyword5']!="" || $_GET['AuctionKeyword6']!="" || $_GET['AuctionKeyword7']!="")||(isset($_GET['NoteAll'])||($_GET['ArtworkKeywords']!="")))
                                {    $AuctionExist = true;
				?>
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchS","ArtworkAuctionSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Notes</a></td>
				<?php }
			
				  if($AuctionExist !== true) echo ("<td class=\"InactiveEmpty\">&nbsp;</td>");
				?>
