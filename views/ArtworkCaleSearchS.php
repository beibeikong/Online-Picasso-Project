...
require_once(MODULES_PATH.'ArtworkCaleSearchS.php');
$obj = new ArtworkCaleSearchS($_GET);
$result = $obj->getData();
...
$hrefForSmall = str_replace("ArtworkCaleSearchS", "ArtworkCaleSearchPrintS", $href_temp);
$hrefForLarge = str_replace("ArtworkCaleSearchS", "ArtworkCaleSearchPrintL", $href_temp);
?>
<center>
		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCaleSearchS","BioCalendarSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Biography</a></td>
	            <td class="Active"><img src="./images/magnify-art.png"/>Artwork Summary</td>
	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCaleSearchS","ArtworkCaleSearchD",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Display</a></td>
...
<?php $i = 1; while($row = mysql_fetch_array($result)){ 
  ...
  <tr <?=($i%2==0)? "class=\"Even\"" : ""?>>
    ...
    <td width="120" height="116" style="padding:4px"><table class="ThumbGallery"><tr><td class="Pic">
		...
		?>
		<img src="http://picasso.shsu.edu/graphics/<?= $row['StartYear']?>/xthumbs/x<?=$obj->imgName($row['opp'])?>.jpg" class="imageStyle" title="<?=$row['title']?>"/><?php	}
		else{
			?>
