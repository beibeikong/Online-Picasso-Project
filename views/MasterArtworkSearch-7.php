...
<script type="text/javascript" src=" ./js/popup.js"></script>
 ...
 <body onload="window.name='OPPMain';">
  <?php
   require_once(MODULES_PATH.'MasterArtworkSearch.php');
      ...
      <tr>
       <td align="center" valign="top">	
        <table border="0" align="center" cellpadding="0" cellspacing="0">
         <tr>
          <td><h1><center>Source Artwork</center></h1><h2><?php if(isset($_GET['author'])) echo $_GET['author']; ?></h2><br/></td>
         </tr>
        </table>
	</td>
      </tr>   
      <tr>
       <td>
        <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
         <tr class="Tabs">
	   <td class="Active"><img src="./images/magnify-art.png"/>Source Artworks</td>
	   <td class="Inactive"><a href="index.php?view=MasterSearch"/><img src="./images/magnify-art.png"/>Sources</a></td>		                
...
<td width="85" align="left" valign="middle">
   ...
   <?php
    ...
    <?php } }?>
	<a href="index.php?view=MasterCompare&MasterID=<?=$row['masteropp']?>" target="_blank" onclick="OpenWin(this.href, 'MasterCompare', 740, 550); return false;"  class="SmallControl"  title="Zoom Artwork Image"><img src="./images/tinyicon-magnify.png" alt=""/>&nbsp;Compare</a>
