...
require_once(MODULES_PATH.'ArtworkSummary.php');
$obj = new ArtworkSummary($_GET);
$result = $obj->getData();
...
$hrefForSmall = str_replace("ArtworkSummary", "ArtworkSmall", $href_temp);
$hrefForLarge = str_replace("ArtworkSummary", "ArtworkLarge", $href_temp);
            ...
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
  	            <td class="Inactive"><a href="index.php?view=BioIndex&year=<?=$_GET['year']?>&quarter=<?=$q?>"><img src="./images/magnify-text.png"/>Biography</a></td>
                    <?php
                        $href = "index.php?".$_SERVER['QUERY_STRING'];
                        $href = str_replace("ArtworkSummary", "ArtworkDisplay", $href);
						
                    ?>
	            <td class="Inactive"><a href="<?=$href?>"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
	            <td class="Active"><img src="./images/magnify-text.png"/>Artwork Summary</td>
	            <?php
				                        $href = "index.php?".$_SERVER['QUERY_STRING'];
				                        $href = str_replace("ArtworkSummary", "ArtworkConcordance", $href);
                ?>
    ...
    <td width="150px" align="right">
	  <table cellspacing="0" style="clear:none; float:left">
        <tr>
          ...
          <td><a class="PageButton" href="javascript:;" onclick="SubmitWorksBasketAdd('ArtworkList','WorkBasketSummary');" title="Add the selected items to the artwork series."><img src="./images/icon-addtobasket.gif" width="16" height="16" border="0" alt=""/><br/>Add</a> 
		  </td>
...
<?php $i = 1; while($row = mysql_fetch_array($result)){ 
  ...
  <tr <?=($i%2==0)? "class=\"Even\"" : ""?>>
    ...
    <td width="120" height="116" style="padding:4px"><table class="ThumbGallery"><tr><td class="Pic">
	        <a href="index.php?view=ArtworkInfo&OPPID=<?=$row['opp']?>" target="_blank" onclick="OpenWin(this.href, 'ArtworkInfo', 740, 550); return false;"><?php	if($_SESSION['UserType'] == 'admin' || $row['notVerified'] == 0){
		?>
