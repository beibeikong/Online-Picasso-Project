		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
	            <td class="Inactive"><a href="index.php?<?=str_replace("FormerCollecArtworkSearchS","FormerCollecArtworkSearchD",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
	            <td class="Active"><img src="./images/magnify-art.png"/>Artwork Summary</td>		     
				<td class="Inactive"><a href="index.php?<?=str_replace("FormerCollecArtworkSearchS","FormerCollecArtworkSearchP",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Provenance</a></td>
...
$AcceptedTitle = $obj->getAcceptedTitle($row['title']);$formercount = $obj->formercollec($row['opp']);?>
  <tr <?=($i%2==0)? "class=\"Even\"" : ""?>>
    ...
    <td width="120" height="116" style="padding:4px"><table class="ThumbGallery"><tr><td class="Pic"><a href="index.php?view=ArtworkInfo&OPPID=<?=$row['opp']?>" target="_blank" onclick="OpenWin(this.href, 'ArtworkInfo', 748, 600); return false;">
	  <?php
	  if ($_SESSION['UserType'] == 'admin' || $row['notVerified'] == 0){
	  ?>
