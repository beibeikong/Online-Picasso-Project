  ...
  <tr>
    <td width="188" height="405" align="center" style="padding:1px ">
	  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
	   ...
	   <br><hr/><strong><font color="#800000"><?=$row['opp']?></font></strong><?php  $result1 = $obj->getCatalog($row['opp']); foreach($result1 as $cata) echo("; ".$cata); if($row['bookCatalog']!='') echo("; ".$obj->sortBooks($row['bookCatalog']));?>
	  </td></tr></table>
	</td>
