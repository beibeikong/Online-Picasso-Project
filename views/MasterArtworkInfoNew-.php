...
<title>Source Details - <?=PROJECTNAME?></title>
...
<table class="HeaderBar" cellspacing="0">
  <tr>
    ...
    <td class="Title">Source Details</td>
    <td class="Toolbar">
	...
	<?php if(trim($row['commentary'])!="") { ?>
          ...
          <?php } ?>
      <?php if($oppcount!=0) { ?>
                 		  <td><a id="NtAndComtry" href="index.php?view=MasterCompare&MasterID=<?=$row['masteropp']?>" target="_blank" onclick="OpenWin(this.href, 'MasterCompare', 740, 750); return false;">Compare</a></td>
		        <?php } ?>
