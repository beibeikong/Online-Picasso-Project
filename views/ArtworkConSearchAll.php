...
<?php
require_once(MODULES_PATH.'ArtworkConSearchAll.php');
$obj = new ArtworkConSearchAll($_GET);
...
if(isset($_GET['view'])) $href3 = str_replace("view=".urlencode($_GET['view']), "view=ArtworkConSearch", $href);
else $href3 = $href;
	...
	<td width="150px" align="right" >
             <table cellspacing="0" style="clear:none; float:right">
                <tr>
                    ...
                    <td><a class="PageButton" target="_self" href="<?=$href3?>"><img src="./images/icon-addtobasket.gif" width="16" height="16" border="0" alt=""/><br/>Partial</a></td> 
        </tr>
            </table>
                    </td>
  </tr>
