		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
			     <td class="Inactive"><a href="index.php?<?=str_replace("GuideSearchD","GuideSearchB",$_SERVER['QUERY_STRING'])?>&page=1"><img src="./images/magnify-text.png"/>Biography</a></td>
	            <td class="Active"><img src="./images/magnify-art.png"/>Artwork Display</td>
	            <td class="Inactive"><a href="index.php?<?=str_replace("GuideSearchD","GuideSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>
