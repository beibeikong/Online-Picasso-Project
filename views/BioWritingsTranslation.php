        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <td>
            ...
            <tr class="Tabs">
				...
				<td class="Inactive"><a href="index.php?view=BioWritingsComntry&year=<?php echo($_GET['year']); if(isset($_GET['page'])) echo("&page=".$_GET['page']);if(isset($_GET['part'])) echo("&part=".$_GET['part']);?>&mid=<?=$_GET['mid']?>"><img src="./images/magnify-text.png"/>Commentary</a></td>
				<?php } ?>
				<td class="Active"><img src="./images/magnify-text.png"/>Translation</td>
				<?php if($i==0) {?>
...
<!---------------------------- Start displaying translation ---------------------------->
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top" style="text-align:justify ">
	<?php $image=$obj->getImage();
	  echo($obj->getTranslation());
	?>
	</td>
	...
	{?>
       <td align="center" valign="top" id="itd" width="200" style="padding-left:50px ">
       <a href="index.php?view=zoom&random=<?=intval('19'.substr($image,4,2))*23?>&alpha=<?=$obj->imgName($image)?>.jpg" target="_blank" onclick="OpenWin(this.href, 'ArtworkZoom', 850, 600); return false;">
...
<?php
	...
	{?>
<td align="center" valign="top" id="itd" width="100%" style="padding-left:50px ">
       <img="index.php?view=zoom&random=<?=intval('19'.substr($image,4,2))*23?>&alpha=<?=$obj->imgName($image)?>.jpg" >
	<img src="../graphics/19<?=substr($image,4,2)?>/ythumbs/y<?=$obj->imgName($image)?>.jpg" border="0"/></a>
	<span class="small">Copyright © Estate of Pablo Picasso/<br/>
	Artists Rights Society (ARS), New York</span>
	</td>
