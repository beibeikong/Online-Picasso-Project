...
<body onload="window.name='OPPMain'; highlightSearchTerms('<?=$_GET['Keywords']?>','BioHighlightTarget');">
<?php
...
<td class="Inactive"><a href="index.php?<?=str_replace("BioSearchSummary","ArtworkSearchDSummary",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
<td class="Inactive"><a href="index.php?<?=str_replace("BioSearchSummary","ArtworkSearchSSummary",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Summary</a></td>
...
?>
  <tr>
    <td class="duration"><?=$row['dateDesc']?>:
	 ...
	 ?>
	   <a href="index.php?view=BioWritings&mid=<?=$writingsRow['mid']?>&year=<?=$row['StartYear']?><?=str_replace("view=BioSearch","",$_SERVER['QUERY_STRING'])?>" class="Biotab" target="OPPMain" title="View Writings made during this timeframe">Writings</a>
     <?php } } ?>
	...
	?>
		...
		<a  href="index.php?view=BioPhotoZoom&img=/photos/<?=$currentYear?>/<?=$photoName?>" target="_blank" onclick="OpenWin(this.href, 'BioZoom', 850, 650); return false;" class="Biotab" title="<?=$photoDescrption?>">Photo</a>    
    ...
    <td class="title" id="bioContent"><?=$obj->parseText($row['event'],$row['StartYear'],$page)?></td>
  </tr>
<?php } ?>
</table>
</div>
