          ...
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
				...
				<td class="Inactive"><a href="index.php?<?=str_replace("GuideSearchB","GuideSearchD",$_SERVER['QUERY_STRING'])?>&page=1"><img src="./images/magnify-art.png"/>Artwork Display</a></td>
				<td class="Inactive"><a href="index.php?<?=str_replace("GuideSearchB","GuideSearchS",$_SERVER['QUERY_STRING'])?>&page=1"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>
  ...
  <tr>
	...
	<td width="150px" align="right" >
	  <table cellspacing="0" style="clear:none; float:right">
	    <tr>
          <td>
            <a class="PageButton" href="index.php?<?=str_replace("GuideSearchB", "printOverviewBioSearch", $_SERVER['QUERY_STRING'])?>" target="_blank" onclick="if(!PrintWarning()) return false;" ><img src="./images/icon-print.gif" width="16" height="16" border="0"/><br/>Print</a>
		  </td>
		</tr>
      </table>
	</td>
