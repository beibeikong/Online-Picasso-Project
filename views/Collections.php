...
<?php
require_once(MODULES_PATH.'Collections.php');
$obj = new Collections($_GET['letter']);
$result = $obj->getData();
$totalNum = $obj->getTotalNum();
$middle = ceil($totalNum/2);
$para='&CategorySearchIn1=painting&CategorySearchIn6=drawing&CategorySearchIn8=gouache&CategorySearchIn9=pastel&CategorySearchIn7=watercolor&CategorySearchIn4=sculpture&CategorySearchIn2=collage&CategorySearchIn3=photograph&CategorySearchIn10=engraving&CategorySearchIn11=lithograph&CategorySearchIn5=ceramic&CategorySearchIn12=other&SearchStyle=Continuous&SearchBy=monthday&StartMonth=1&StartDay=1&StartYear=1881&EndMonth=12&EndDay=31&EndYear=1973';
?>
<center>
          ...
          <td align="center" valign="middle">	
		    <table border="0" align="center" cellpadding="0" cellspacing="0">
		      <tr>
			    ...
			    <td><span class="big_year"><?=$_GET['letter']?></span></td>
                <td width="40" align="center">
			    </td>
		      </tr>
	        </table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
	  <table width="98%" class="EntriesList" align="center" cellpadding="1"  cellspacing="0">
	    ...
	    <tr <?=($i%2!=0)? "class=\"Even\"" : ""?>>
    	 <td class="authors" align="left" valign="top" ><b><a href="index.php?view=ListArtworkSearchS&page=1&Keyword=<?=urlencode($row['collection'])?>&SearchIn=Collection<?=$para?>" class="collection"><?=$row['collection']?></a></b></td>
