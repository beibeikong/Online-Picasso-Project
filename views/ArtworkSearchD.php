          ...
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
	            ...
	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchD","ArtworkSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>
               <?php 
				$commentaryExist = false; $AuctionExist = false;
				if(isset($_GET['Commentaryres'])||$_GET['Commentary']!="") { $commentaryExist = true;?>
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchD","ArtworkCommSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Commentary</a></td>
				<?php } 
				  ...
				  { $AuctionExist = true;
				?>			
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkSearchD","ArtworkAuctionSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Notes</a></td>
				<?php } 
