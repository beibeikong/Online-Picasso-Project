          ...
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
	            ...
	            <td class="Inactive"><a href="index.php?<?=str_replace("FormerCollecArtworkSearchD","FormerCollecArtworkSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Summary</a></td>		   
				<td class="Inactive"><a href="index.php?<?=str_replace("FormerCollecArtworkSearchD","FormerCollecArtworkSearchP",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-art.png"/>Artwork Provenance</a></td>
...
<tr>
  <td width="20%">
    <table class="ThumbGallery">
      <tr><td class="Pic"><a href="index.php?view=ArtworkInfo&OPPID=<?=$row['opp']?>" target="_blank" onclick="OpenWin(this.href, 'ArtworkInfo', 748, 600); return false;">
	  <?php
