...
<title>Artwork Note - <?=PROJECTNAME?></title>
...
<?php
	...
	?>
  <td  valign="top" id="ImgHolder"><br /><?php
  ...
  <td  align="center" > 
   <iframe  id="noteiframe" class="iframeNote" src ="index.php?view=note&OPPID=<?=$_GET['OPPID']?>" align="left" width="97%" height="450px"  scrolling="auto" frameborder="0">
   </iframe>
  </td>
 </tr>
</table>
