		...
		<tr>
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCommSearch","ArtworkSearchD",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Display</a></td>
                    <td class="Active"><img src="./images/magnify-text.png"/>Artwork Commentary</td>
                    <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCommSearch","ArtworkSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>

                                
				<?php
				if(($_GET['Commentaryres'] = "")||$_GET['Commentary']="")
                                    {  
                                    ?>                          
                                            
  	                        <td class="Active"><a href="index.php?<?=str_replace("ArtworkCommSearch","ArtworkSearchS",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Summary</a></td>
                             <?php }
                            
                                  ?>
				<?php 
				  if($_GET['AuctionKeyword1']!="" || $_GET['AuctionKeyword2']!="" || $_GET['AuctionKeyword3']!="" || $_GET['AuctionKeyword4']!="" || $_GET['AuctionKeyword5']!="" || $_GET['AuctionKeyword6']!="" || $_GET['AuctionKeyword7']!="") 
				  { 
				?>			
  	            <td class="Inactive"><a href="index.php?<?=str_replace("ArtworkCommSearch","ArtworkAuctionSearch",$_SERVER['QUERY_STRING'])?>"><img src="./images/magnify-text.png"/>Artwork Auction</a></td>
				<?php } 
				  else echo ("<td class=\"InactiveEmpty\">&nbsp;</td>");
				?>
	...
	<td width="150px" align="right" >
	  <table cellspacing="0" style="clear:none; float:right">
	    <tr>
                ...
                <td><a class="PageButton" href="index.php?<?=str_replace("ArtworkCommSearch", "ArtworkCommSearchPrint", $_SERVER['QUERY_STRING'])?>" target="_blank" onclick="if(!PrintWarning()) return false;"><img src="./images/icon-print.gif" width="16" height="16" border="0"/><br/>Print</a>
		</td>
            </tr>
      </table>
	</td>
...
$AcceptedTitle = $obj->getAcceptedTitle($row['title']);$formercount = $obj->formercollec($row['opp']);?>
  <tr>
    <td width="120" align="left" valign="top" style="padding:4px"><table class="ThumbGallery"><tr><td class="Pic"><a href="index.php?view=ArtworkInfo&OPPID=<?=$row['opp']?>" target="_blank" onclick="OpenWin(this.href, 'ArtworkInfo', 748, 600); return false;">
	  <?php
...
<td align="center" valign="top"><iframe id="noteiframe" class="iframeNote" src ="index.php?view=commentary&OPPID=<?=$row['opp']?><?php if(isset($_GET['Commentary'])&&$_GET['Commentary']!="") echo "&highlight=".$_GET['Commentary']; ?>" align="center" width="100%" onload="javascript:resizeIframe(this);" scrolling="no" frameborder="0"> </iframe>
    </td>
