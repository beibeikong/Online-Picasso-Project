...
class ArtworkList extends Database
{
  private $p;
  private $total;
  ...
  {   
	...
	$query = "select SQL_CALC_FOUND_ROWS title,count(opp) as n from `ARTWORK` A where " ;
...
// ==================================================================================
	...
	$query .= $sqlTimeConstraint.$sqlKeywordConstraint.$sqlcategoryConstraint."group by title order by title asc";
