...
class WorkBasketPrint extends Database
{
  private $opps;
  ...
  {
	$query = "select opp,notVerified,title,duration,collection,inventory,dimension,bookCatalog,medium,location,YEAR(dateStart) as year from `ARTWORK` where opp in $this->opps order by dateStart ASC, dateStartFlag ASC, dateEnd ASC, dateEndFlag ASC" ;
