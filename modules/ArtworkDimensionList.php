...
class ArtworkDimensionList extends Database
{
  private $p;
  private $total;
  ...
  {   
	...
	$query = "select SQL_CALC_FOUND_ROWS dimension,count(opp) as n from `ARTWORK` A where " ;
...
// ==================================================================================
	...
	$query .= $sqlTimeConstraint.$sqlKeywordConstraint.$sqlcategoryConstraint."group by dimension order by dimension asc";
