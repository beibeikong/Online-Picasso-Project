...
class ArtworkInfo extends Database
{
  ...
  public function countmaster($opp)
  {
	$query = "SELECT count(masteropp) FROM `RLTN_MASTERARTWORK_ARTWORK` WHERE opp = '$this->oppID'";
	$result = mysql_query($query);
	$record = mysql_fetch_array($result);
	$count = $record['count(masteropp)'];
	return $count;
  }
  
  public function countrelation($opp)
  {
	$query = "SELECT count(opp) FROM `RLTN_ARTWORK_ARTWORK` WHERE oppmaster = '$this->oppID'";
	$result = mysql_query($query);
	$record = mysql_fetch_array($result);
  ...
  {
	$query = "SELECT count(opp) FROM `FORMERLY` WHERE opp = '$this->oppID'";
	$result = mysql_query($query);
	$record = mysql_fetch_array($result);
