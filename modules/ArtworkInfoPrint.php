...
class ArtworkInfoPrint extends Database
{
  private $oppID;
 ...
 public function getRef($keywords1,$keywords2)
  { 
  	$query = "SELECT SQL_CALC_FOUND_ROWS id,Author,Books,Catalogs,Title,Date,Publisher,Journal,Edition,Issue,Volume FROM `REFERENCES` WHERE ";
	if ( trim($keywords1) != '') {
