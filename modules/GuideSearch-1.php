...
class GuideSearch extends Database
{
  private $p;
...
// ==================================================================================	
	...
	$query .= $tempquery.$sqlOrderBy." limit $limitStart, $limitEnd";
    //echo $query;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
  ...
  private function generateSorting()
  {
	...
	{
	  $direction = mysql_real_escape_string($this->p['SortDirection1']);
	  $sqlOrderBy = " ORDER BY case category when 'painting' then 1 when 'sculpture' then 2 when 'collage' then 3 when 'relief' then 4 when 'watercolor' then 5 when 'gouache' then 6 when 'pastel' then 7 when 'drawing' then 8 when 'ceramic' then 9 when 'engraving' then 10 when 'lithograph' then 11 else 12 end ";
	}
	else
	{
