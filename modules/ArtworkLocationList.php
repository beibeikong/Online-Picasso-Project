...
class ArtworkLocationList extends Database
{
  private $p;
  private $total;
  ...
  {   
	...
	$query = "select SQL_CALC_FOUND_ROWS location,count(opp) as n from `ARTWORK` A where " ;
...
// ==================================================================================
	...
	$query .= $sqlTimeConstraint.$sqlKeywordConstraint.$sqlcategoryConstraint."group by location order by location asc";
