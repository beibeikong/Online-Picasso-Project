...
class ArtworkMediumList extends Database
{
  private $p;
  private $total;
  ...
  {   
	...
	$query = "select SQL_CALC_FOUND_ROWS medium,count(opp) as n from `ARTWORK` A where " ;
...
// ==================================================================================
	...
	$query .= $sqlTimeConstraint.$sqlKeywordConstraint.$sqlcategoryConstraint."group by medium order by medium asc";
