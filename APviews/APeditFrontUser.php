...
<title>Edit Front User - <?=PROJECTNAME?></title>
...
<table class="HeaderBar" cellspacing="0">
  <tr>
    ...
    <td class="Title">Modify Front User</td>
    <td class="Toolbar">
      ...
      <table class="TabContainer" id="SideBar" cellspacing="0" align="center">
		...
		<tr>
		  ...
		  <div id="Tab1Side">
			...
			<tr>	
			    <td class="Label"><label for="title">User Name:</label> </td>
				<td><input value="<?=$_GET['id']?>" size="30" id="UserName" name="UserName" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Password:</label> </td>
				<td><input value="" size="30" id="Password" name="Password" type="password"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Re-type Password:</label> </td>
				<td><input value="" size="30" id="Password2" name="Password2" type="password"></td>
			  </tr>	
                        <tr>	
			    <td class="Label"><label for="title">User Type:</label> </td>
				<td><input value="" size="30" id="UserType" name="UserType" type="text"></td>
			  </tr>			  
			</table>
		  </div>
		  </td>
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" onclick="OnSaveModifiedForm('ModifyFrontUserEngine'); return false;" id="SaveButton">Save</button>
		  </td>
		</tr>
	  </table>
	</div>
