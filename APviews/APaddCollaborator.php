		  ...
		  <div id="Tab1Side">
			...
			<tr>	
			  ...
			  <tr>	
				...
				<td><input value="" size="30" id="Position" name="Position" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Place:</label> </td>
				<td><input value="" size="30" id="Place" name="Place" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Order<br>Priority:</label> </td>
				<td><input value="" size="30" id="OrderPriority" name="OrderPriority" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Category:</label> </td>
				<td><input value="" size="30" id="Category" name="Category" type="text"></td>
			  </tr>
			</table>
		  </div>
		  </td>
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" onclick="OnSaveForm('AddColEngine'); return false;" id="SaveButton">Save</button>
		  </td>
		</tr>
	  </table>
	</div>
