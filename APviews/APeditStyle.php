...
<title>Modify Period - <?=PROJECTNAME?></title>
...
<body>
<?php
require_once(APMODULES_PATH.'ModifyStyle.php');
$obj = new ModifyStyle($_GET['guidename']);
$row = $obj->getData();
?>
<table class="HeaderBar" cellspacing="0">
  <tr>
    <td class="Logo"><img src="./images/opp-emblem-corner.png" width="61" height="59" /></td>
    <td class="Title">Modify Period</td>
    <td class="Toolbar">
 ...
 <table class="TabContainer" cellspacing="0" align="center">
		...
		<tr>
		  <td class="Container" colspan="4">
		    <div id="Tab1"><textarea name="Opps" id="Opps" rows="24" cols="63" disabled><?php $result1 = $obj->getOPP($row['guidename']); foreach($result1 as $opp) echo($opp."; "); ?></textarea></div>
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" onclick="OnSaveModifiedGuideForm('ModifyStyleEngine'); return false;" id="SaveButton">Save</button>
			&nbsp;&nbsp;&nbsp;
