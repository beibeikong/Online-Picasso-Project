...
<table id="ArtworkInfo" cellspacing="0" align="center">
  <tr>
    <td id="ImgHolder"><img src="../graphics/<?=$_POST['StartYear']?>/ythumbs/y<?=$obj->imgName($_POST['CatID'])?>.jpg" class="imageStyle" /><br/><small>Copyright © Estate of Pablo Picasso/<br/>Artists Rights Society (ARS), New York</small></td>
	<td id="InfoHolder">
  ...
  <tr>
	<td class="Container" colspan="2"><table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="InfoLabel">Location:</td> <td class="Info"><?=$_POST['Location']?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="InfoLabel">Collection:</td> <td class="Info"><?=$_POST['Collection']?>.&nbsp;
	  	<?php if($_POST['Inventory']!='') {
	  ...
	  <?php }?>
      <tr> 
        <td class="InfoLabel">Catalog:</td> <td class="Info"><?php if(isset($_POST['NotVerified'])) {?>
	  <strong><font color="#800000">[<?=$_POST['CatID']?>]</font></strong>
	  <?php } else { ?><strong><font color="#800000"><?=$_POST['CatID']?></font></strong><?php } if(trim($_POST['Catalog'])!=="") echo("; ".str_replace("\r","; ", $_POST['Catalog']));?>
      </td>
      </tr>
	  <?php if($_POST['BookCatalog']!='') { ?>
      <tr>
        <td class="InfoLabel">Books:</td> <td class="Info"><?=str_replace("\r","; ", $_POST['BookCatalog'])?></td>
      </tr>
	  <?php }?>	  
    </table></td>
  </tr>
