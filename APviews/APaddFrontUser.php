...
<title>Add Front User - <?=PROJECTNAME?></title>
...
<table class="HeaderBar" cellspacing="0">
  <tr>
    ...
    <td class="Title">Add Front User</td>
    <td class="Toolbar">
		...
		<tr>
		  ...
		  <div id="Tab1Side">
			<table class="DataEntry" cellspacing="2">
				...
				<td><input value="" size="30" id="UserName" name="UserName" type="text"></td>
			  </tr>
			  <tr>	
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" onclick="OnSaveForm('AddFrontUserEngine'); return false;" id="SaveButton">Save</button>
		  </td>
		</tr>
	  </table>
	</div>
