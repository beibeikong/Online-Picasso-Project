...
<?php
require_once(APMODULES_PATH.'GuideTheme.php');
$obj = new GuideThemes($_GET);
$result = $obj->getData();
          ...
          <td>
            <table class="TabContainer" id="MenuTabs" cellspacing="0" align="center">
              <tr class="Tabs">
				...
				<td class="Active"><img src="./images/magnify-art.png"/>Theme</a></td>		                
  ...
  <tr>
    <td width="150px" align="left">
	  <table cellspacing="0" class="NavBar" align="left">
        <tr>
          <td><button type="button" onclick="addTheme(); return false;"><img src="./images/icon-add.png" width="16" height="16" alt="" title="Add Entry"/> Add</button></td>
        </tr>
      </table></td>
	
	<td>
   	  <h2><?=$totalNum?> Themes</h2>	
	</td>
  ...
  <tr>
	<td>
	  <form method="get" action="AuthorIndex.php" target="OPPMain">
		  <input type="text" name="view" id="view" size="1" value="GuideTheme" style=" display:none"/>
		  Sorting:&nbsp;<select size="1" name="SortBy"><option>Label</option><option>Time</option></select>&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php $i = 1; while($row = mysql_fetch_array($result)){ ?>  
  <tr <?=($i%2!=0)? "class=\"Even\"" : ""?>>
    <td class="EditBtn"><button type="button" onclick="EditTheme('<?=urlencode($row['guidename'])?>');"><img src="./images/icon-modify.png" width="16" height="16" alt="" title="Modify Entry" class="aaa"/></button>
    <br />
	<button type="button" onclick="DeleteEntry('<?=$row['guidename']?>', 'deleteThemeEngine');"><img src="./images/icon-delete.png" width="16" height="16" alt="" title="Delete Entry" class="aaa"/></button></td> 
