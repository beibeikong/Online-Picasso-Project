...
<title>Add Collaborator - <?=PROJECTNAME?></title>
...
<body>
<?php
require_once(APMODULES_PATH.'ModifyCollaborator.php');
$obj = new ModifyCollaborator($_GET['id']);
$row = $obj->getData();
?>
<table class="HeaderBar" cellspacing="0">
  <tr>
    <td class="Logo"><img src="./images/opp-emblem-corner.png" width="61" height="59" /></td>
    <td class="Title">Add Collaborator</td>
    <td class="Toolbar">
		...
		<tr>
		  ...
		  <div id="Tab1Side">
			...
			<tr>	
			  ...
			  <tr>	
			    <td class="Label"><label for="title">Position:</label> </td>
				<td><input value="<?=$row['Position']?>" size="30" id="Position" name="Position" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Place:</label> </td>
				<td><input value="<?=$row['Place']?>" size="30" id="Place" name="Place" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Order<br>Priority:</label> </td>
				<td><input value="<?=$row['OrderPriority']?>" size="30" id="OrderPriority" name="OrderPriority" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="title">Category:</label> </td>
				<td><input value="<?=$row['Category']?>" size="30" id="Category" name="Category" type="text"></td>
			  </tr>
			</table>
		  </div>
		  </td>
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" onclick="OnSaveForm('ModifyColEngine'); return false;" id="SaveButton">Save</button>
		  </td>
		</tr>
	  </table>
	</div>
