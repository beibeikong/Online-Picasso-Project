...
<table class="HeaderBar" cellspacing="0">
  <tr>
    ...
    <td class="Title">Add Bio Resource</td>
    <td class="Toolbar">
		  ...
		  <div id="Tab1Side">
			<table class="DataEntry" cellspacing="2">
			  <tr>	
				...
				<td><input size="30" id="ids" name="ids" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="location">Name:</label> </td>
			    <td><input size="30" id="Name" name="Name" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="location">Type:</label> </td>
			    <td><input size="30" id="Type" name="Type" type="text"></td>
			  </tr>
			  <tr>	
			    <td class="Label"><label for="location">General Type:</label> </td>
			    <td><input size="30" id="GeneralType" name="GeneralType" type="text"></td>
			  </tr>
			</table>
		  </div>
		  </td>
...
<!-------------- start right panel --------------------------->	
 <table class="TabContainer" cellspacing="0" align="center">
		...
		<tr>
		  <td class="Container" colspan="2">
		    <div id="Tab1"><textarea name="XMLCode" cols="63" rows="24" wrap="OFF" id="XMLCode"></textarea>
		    </div>
		  </td>
		</tr>
	  </table>
...
<table class="ActionButtons" cellspacing="0" align="center">
  <tr>
    ...
    <div>
	  <table class="StatusHolder" cellspacing="0">
		<tr>
		  ...
		  <td>
			<button type="button" name="saveButton" value="save" onclick="OnSaveForm('AddBioResourceEngine'); return false;" id="SaveButton">Save</button>
		  </td>
		</tr>
	  </table>
	</div>
	...
	<td>
	<div>
	  <button type="button" onclick="PreviewEntry(this.form, 'BioResourcePreview', 'BioResourcePreview', 740, 580)">Preview</button>
	</div>
	</td>
  </tr>
</table>
